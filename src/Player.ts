...
export class Player extends EventEmitter {
  ...
  constructor(client: Client, options: PlayerOptions = {}) {
    ...
    this.client.on('voiceStateUpdate',
      (oldState, newState) =>
        this.voiceUpdate(oldState, newState)
    );
  }
   ...
   * @returns {Queue}
   */
  public createQueue(guildId: Snowflake, options: PlayerOptions & { data?: any } = this.options): Queue {
   ...
   * @returns {boolean}
   */
  public hasQueue(guildId: Snowflake): boolean {
   ...
   * @returns {void}
   */
  public setQueue(guildId: Snowflake, queue: Queue): void {
   ...
   * @returns {void}
   */
  public deleteQueue(guildId: Snowflake): void {
   ...
   * @returns {void}
   */
  private voiceUpdate(oldState: VoiceState, newState: VoiceState): void {
